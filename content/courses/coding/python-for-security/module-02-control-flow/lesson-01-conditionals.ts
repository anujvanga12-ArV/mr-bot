...
export const conditionals: Lesson = {
  ...
  title: "Conditionals",
  estimatedMinutes: 10,
  objective: "Use if/elif/else to make a script react differently to different input — the backbone of any check or validator.",
  blocks: [
    {
      type: "text",
    ...
    },
    {
      ...
      correctOptionId: "b",
      explanation: "failed_attempts (3) isn't >= 5, so the first branch is skipped. It is >= 3, so \"Warning\" prints, and \"OK\" never runs since a match was already found.",
