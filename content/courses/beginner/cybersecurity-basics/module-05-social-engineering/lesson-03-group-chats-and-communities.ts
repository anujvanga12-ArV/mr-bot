...
export const groupChatsAndCommunities: Lesson = {
  ...
  estimatedMinutes: 9,
  objective:
    "Apply social engineering awareness to group and community settings, where trust spreads socially.",
  blocks: [
    {
      type: "text",
    ...
    },
    {
      type: "question",
      prompt:
        "Why can group chats and communities make social engineering more convincing, not less?",
      options: [
        { id: "a", text: "Because groups are always more careful than individuals" },
        {
          id: "b",
          text: "Because seeing multiple people seem to trust something creates social proof, even if some of those accounts are fake",
        },
      ],
      correctOptionId: "b",
      explanation:
    ...
    questions: [
      {
        ...
        correctOptionId: "a",
        explanation:
          "It manipulates people directly, which is why it can succeed even against technically secure systems.",
      },
      {
        type: "question",
        prompt:
          'Someone claiming to be a game moderator asks for your password to "verify" your account. What\'s true?',
        options: [
        ...
        correctOptionId: "a",
        explanation:
          "This is one of the most reliable red flags across almost every social engineering scenario.",
      },
      {
        type: "question",
        prompt:
          'Multiple unfamiliar accounts in a chat all hype the same "giveaway" at once. What should that make you think?',
        options: [
          { id: "a", text: "It must be real since so many people are excited" },
          {
            id: "b",
            text: "This could be manufactured social proof — check an official channel instead",
          },
        ],
        correctOptionId: "b",
        explanation:
          "Coordinated hype from unfamiliar accounts is a known tactic for making a scam feel credible.",
      },
      {
        type: "question",
        prompt:
          'A chat acquaintance asks to briefly borrow your game account to "help" with something. What\'s the safest response?',
        options: [
        ...
        correctOptionId: "a",
        explanation:
          "Built-up familiarity is exactly what this kind of request relies on — it doesn't make handing over credentials safe.",
      },
    ],
  },
};
